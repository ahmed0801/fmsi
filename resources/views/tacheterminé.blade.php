...
@endif
                ...
                <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
                  <ul class="nav nav-tabs tab-transparent" role="tablist">
                    <li class="nav-item">
                    <li class="nav-item">
                      <a class="nav-link active" id="business-tab" data-toggle="tab" href="#business-1" role="tab" aria-selected="false">Historiques Des Taches Terminées</a>
                    </li>
                  </ul>
  ...
  <div class="col-sm-4">
    ...
    <input type="date" class="form-control" id="inputdate" placeholder="Filtrer les tâches...">
                ...
                <!-- fin search  -->
                    <div class="row">
                    @foreach($mestachesterminé as $tache)
                    <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card filter-item" data-designation="{{ $tache->designation }}" data-etat="{{ $tache->etat }}" data-date="{{ $tache->datetache }}" data-client="{{ $tache->numclient }}" data-adresse="{{ $tache->adresse }}" data-nameclient="{{ $tache->nameclient }}">
                        ...
                        <div class="card">
                          <div class="card-body text-left">
                            ...
                            <h4 class="mb-1 text-dark font-weight-normal"><b>Etat :</b>
                            <span class="badge badge-success"> {{ $tache->etat }}
