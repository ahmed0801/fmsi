...
<html lang="en">
  <head>
    ...
    <style>
  /* CSS personnalisé pour ajuster la taille des champs d'entrée */
.designation-input {
...
.priceht-input {
  ...
  <li class="nav-item">
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    Créer un Devis</h4>
                    <p class="card-description"> Devis Client </p>
                    <form class="forms-sample" action="{{ route('devis.insert') }}" method="POST">
                    @csrf
    ...
    <select id="clientselect" class="form-control" name="clientfac" required size="5" required>
...
<!-- test new client -->
<div class="col-md-1">
<label for="exampleInputEmail3">Nouveau</label>
<button type="button" class="btn btn-success" id="test" data-toggle="modal" data-target="#model">+</button>
...
<!-- fin test new client -->
  <div class="col-md-6">
    <label for="exampleInputName1">Date Devis</label>
...
<div id="services-container" class="col-md-12">
  ...
  <!-- fin add -->
    ...
    <input type="hidden" name="service-ids" id="service-ids" class="service-ids" value="">
                      ...
                      <button type="submit" class="btn btn-primary mr-2">Créer Le Devis</button>
                    </form>
                  </div>
                </div>
              </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
                    ...
                    <form class="forms-sample" action="{{ route('insertClientfromDevisFacture') }}" method="POST">
                    @csrf
                      <div class="form-group">
                      ...
                      <div class="form-group row">
                      <div class="col-md-9">
                        <label for="exampleInputPassword4">Adresse Exacte (adresse / étage)</label>
                        <input type="text" class="form-control" name="adresse" step="0.01" required>
                      </div>
                      <div class="col-md-3">
                      <label for="exampleInputPassword4">Code Porte</label>
                        <input type="text" class="form-control" name="codeporte" step="0.01">
                      </div>
    ...
    <select name="type" id="role" class="form-control" required>
                                    <option value="particulier" selected>Particulier / Syndic</option>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success">Insérer Client</button>
        </form>
