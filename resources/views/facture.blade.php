  ...
  <div class="input-group-append">
    <button class="btn btn-outline-secondary" type="button">
      <i class="mdi mdi-magnify"></i>
                    ...
                    <!-- fin teste filtre  -->
                    <p class="card-description"> Toutes Les Factures FMSI
                    </p>
                    ...
                    <table class="table table-striped" id="clientTable">
                      ...
                      @foreach ($factures as $facture)
                        ...
                        <td> {{ $facture->nameclient }} </td>
                          <td> {{ $facture->clientfac }} </td>
                          <td> {{ $facture->montantfact }} € </td>
                          <td> {{ $facture->reste }} </td>
                          <td> {{ $facture->datefac }} </td>
                          
                          <td> 
                          <a href="{{ route('sendfact', ['num' => $facture->numfac]) }}">
                          <i class="mdi mdi-email-open-outline"></i>
                          </a>
                          <a href="{{ route('editfacture', ['id' => $facture->id]) }}">
