...
<!-- endinject -->
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('client.update', ['id' => $client->id]) }}" method="POST">
  @csrf
  <div class="form-group row">
  <div class="col-md-6">
      <label for="name">Num Client</label>
      <input type="text" name="numclient" id="name" class="form-control" required autofocus value="{{ $client->numclient }}" disabled>
    </div>
    <div class="col-md-6">
      <label for="name">Nom Client</label>
      <input type="text" name="nameclient" id="name" class="form-control" required autofocus value="{{ $client->nameclient }}">
    </div>
  </div>
  ...
  <div class="col-md-6">
      ...
      <input type="text" name="tel1" id="name" class="form-control" autofocus value="{{ $client->tel1 }}">
    </div>
    <div class="col-md-6">
      <label for="name">Téléphone 2 (facultatif)</label>
      <input type="text" name="tel2" id="name" class="form-control" autofocus value="{{ $client->tel2 }}">
    </div>
  </div>
  ...
  <div class="form-group row">
    <div class="col-md-6">
      ...
      <input type="email" class="form-control" id="exampleInputName1" name="mail" required value="{{ $client->mail }}">
    </div>
    <div class="col-md-6">
      <label for="exampleInputName1">Adresse Exacte</label>
      <input type="text" class="form-control" id="exampleInputName1" name="adresse" required value="{{ $client->adresse }}">
    </div>
    ...
    <option value="particulier" {{ $client->type == 'particulier' ? 'selected' : '' }}>Particulier / Syndic</option>
        <option value="entreprise" {{ $client->type == 'entreprise' ? 'selected' : '' }}>Entreprise</option>
    <option value="sous-traitant" {{ $client->type == 'sous-traitant' ? 'selected' : '' }}>Sous-traitant</option>
</select>
  ...
  <a href="/client" class="btn btn-primary mr-2">Fermer</a>
  <button type="submit" class="btn btn-success mr-2">Mettre à jour le client</button>
</form>
 </div>
                  </div>
                </div>
