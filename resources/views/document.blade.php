  ...
  <div class="input-group-append">
    <button class="btn btn-outline-secondary" type="button">
      <i class="mdi mdi-magnify"></i>
                    ...
                    <!-- fin teste filtre  -->
                    <p class="card-description"> Toutes Les Documents FMSI
                    </p>
                    ...
                    <table class="table table-striped" id="clientTable">
                      ...
                      @foreach ($documents as $document)
                        ...
                        <td> {{ $document->gestionnaire }} </td>
                          <td> {{ $document->numclient }} / {{ $document->nameclient }} </td>
                          <td> {{ $document->date }} </td> 
                          <td> 
                          <a href="{{ route('senddocument', ['num' => $document->numdoc]) }}">
                          <i class="mdi mdi-email-open-outline"></i>
                          </a>
                          <a href="{{ route('editdocument', ['id' => $document->id]) }}">
