...
<!-- endinject -->
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Cordonnées Du service </p>
                    <form class="forms-sample" action="{{ route('service.update', ['id' => $service->id]) }}" method="POST">
  @csrf
  <div class="form-group row">
  <div class="col-md-6">
      <label for="name">Description</label>
      <input type="text" name="designation" id="name" class="form-control" required autofocus value="{{ $service->designation }}">
    </div>

    <div class="col-md-6">
      <label for="name">Montant HT</label>
      <input type="number" name="montant_ht" id="montant_ht" class="form-control" required autofocus value="{{ $service->montant_ht }}">
    </div>
  ...
  <div class="col-md-6">
      ...
      <input type="number" name="tva" id="name" class="form-control" required autofocus value="{{ $service->tva }}">
    </div>
    <div class="col-md-6">
      <label for="name">Montant HT</label>
      <input type="number" name="montant_ht" id="montant_ht" class="form-control" required autofocus value="{{ $service->montant_ht }}">
  ...
  <a href="/service" class="btn btn-primary mr-2">Fermer</a>
  <button type="submit" class="btn btn-success mr-2">Mettre à jour le Service</button>
</form>
 </div>
                  </div>
                </div>
