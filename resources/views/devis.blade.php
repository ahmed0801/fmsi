  ...
  <div class="input-group-append">
    <button class="btn btn-outline-secondary" type="button">
      <i class="mdi mdi-magnify"></i>
                    ...
                    <!-- fin teste filtre  -->
                    <p class="card-description"> Toutes Les Devis FMSI
                    </p>
                    ...
                    <table class="table table-striped" id="clientTable">
                      ...
                      @foreach ($devis as $devis)
                        ...
                        <td> {{ $devis->nameclient }} </td>
                          <td> {{ $devis->clientdevis }} </td>
                          <td> {{ $devis->montantdevis }} € </td>
                          <td> {{ $devis->datedevis }} </td>
                          
                          <td> 
                          <a href="{{ route('senddevis', ['num' => $devis->numdevis]) }}">
                          <i class="mdi mdi-email-open-outline"></i>
                          </a>
                          <a href="{{ route('editdevis', ['id' => $devis->id]) }}">
