...
<html lang="en">
  ...
  <li class="nav-item">
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ajouter une Tache</h4>
                    <p class="card-description"> Cordonnées Du Tache </p>
                    <form class="forms-sample" action="{{ route('tache.insert') }}" method="POST">
                    @csrf
                    <div class="form-group row">
                    <div class="col-md-8">
                                <label for="name">Désignation</label>
                                <input type="text" name="designation" id="name" class="form-control" required autofocus>

                    </div>
                    <div class="col-md-4">
                    <label for="role">Employées</label>
                                <select name="userid" id="role" class="form-control" required>
                                    <option value="" disabled selected>1er Employé (Obligatoire)</option>
                                ...
                                <select name="userid2" id="role" class="form-control">
                                    <option value="" disabled selected>2eme Employé (Facultatif)</option>
                                    @foreach($users as $user)
                                    <option value="{{$user->id}}">{{$user->name}}</option>
                                    @endforeach
                                </select>

                                <select name="userid3" id="role" class="form-control">
                                    <option value="" disabled selected>3eme Employé (Facultatif)</option>
                                    @foreach($users as $user)
                                    <option value="{{$user->id}}">{{$user->name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-md-8">
                            <label for="name">Commentaire (facultatif)</label>
                                <input type="text" name="commentaire" id="name" class="form-control" autofocus>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="numclient" id="clientselect" class="form-control" required>
                                    ...
                                    <option value="{{$client->numclient}}">{{$client->nameclient}}</option>
                                    @endforeach
                                </select>
                            </div>
    ...
    <input type="datetime-local" class="form-control" id="exampleInputName1" name="datetache" required>
  </div>

  <div class="col-md-6">
    <label for="exampleInputName1">Priorité</label>
    <select name="priorité" id="role" class="form-control" required>
                                    <option value="Basse" disabled selected>Basse</option>
                      ...
                      <button type="submit" class="btn btn-primary mr-2">Créer La Tache </button>
                    </form>
                  </div>
                </div>
              </div>
