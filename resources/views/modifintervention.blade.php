...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    $(document).ready(function () {
        ...
        $('.delete-btn').click(function (e) {
            ...
            var deleteButton = $(this); // Stocker la référence ici
            ...
            if (confirmation) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        deleteButton.closest('.col-md-6').remove(); // Utiliser la référence ici
                    },
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <!-- fin avoir  -->
              ...
              <div class="collapse" id="ui-basic9">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="/intervention">Liste Des interventions</a></li>
                  <li class="nav-item"> <a class="nav-link" href="/créerintervention">Créer Une Intervention</a></li>
...
@endif
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Rapport D'intervention</h4>
                    <p class="card-description"> Détails Du Rapport </p>
                    <form class="forms-sample" action="{{ route('intervention.update', ['id' => $intervention->id]) }}" method="POST" enctype="multipart/form-data">
  @csrf
  <div class="form-group row">
  <div class="col-md-6">
      <label for="name">Num Intervention</label>
      <input type="text" name="numinter" id="name" class="form-control" required autofocus value="{{ $intervention->numinter }}" disabled>
    </div>
    <div class="col-md-6">
      <label for="name">Date</label>
      <input type="date" name="date" id="name" class="form-control" autofocus value="{{ $intervention->date }}">
    </div>
  </div>

  <div class="form-group row">
    <div class="col-md-6">
      <label for="name">Num Client</label>
      <input type="text" name="numclient" id="name" class="form-control" required autofocus value="{{ $intervention->numclient }}" disabled>
    </div>
    <div class="col-md-6">
      <label for="name">Nom Client</label>
      <input type="text" name="nameclient" id="name" class="form-control" autofocus value="{{ $intervention->nameclient }}" disabled>
    </div>
  </div>
  ...
  <div class="form-group row">
    <div class="col-md-12">
      ...
      <input type="text" name="titre" id="name" class="form-control" autofocus value="{{ $intervention->titre }}">
    </div>
    ...
    <div class="form-group row">
    <div class="col-md-12">
      <label for="name">Détail</label>
      <textarea name="détail" id="name" class="form-control" autofocus rows="10">{{ $intervention->détail }}</textarea>
    </div>
 ...
 <img width="300" height="300" src="{{ asset('storage/intervention/' . $image->photo) }}" alt="image">
 <a href="#" class="btn btn-danger mr-2 delete-btn" data-image-id="{{ $image->id }}">Supprimer</a>
    </div>
    @endforeach  
    </div>
...
@if(Auth::user()->id == "employee")
  <a href="/intervention" class="btn btn-primary mr-2">Fermer</a>
  @else 
  <a href="/mesrapports" class="btn btn-primary mr-2">Fermer</a>

  @endif
  <button type="submit" class="btn btn-success mr-2">Mettre à jour Et Confimer</button>
</form>
 </div>
                  </div>
                </div>
