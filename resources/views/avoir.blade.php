  ...
  <div class="input-group-append">
    <button class="btn btn-outline-secondary" type="button">
      <i class="mdi mdi-magnify"></i>
                    ...
                    <!-- fin teste filtre  -->
                    <p class="card-description"> Toutes Les Avoirs FMSI
                    </p>
                    ...
                    <table class="table table-striped" id="clientTable">
                      ...
                      @foreach ($avoirs as $avoir)
                        ...
                        <td> {{ $avoir->designation }} </td>
                          <td> {{ $avoir->numclient }} </td>
                          <td> {{ $avoir->nameclient }} </td>
                          <td> {{ $avoir->montant }} </td>
                          <td> {{ $avoir->date }} </td>                                                    
                          <td> 
                          <a href="{{ route('sendavoir', ['num' => $avoir->numavoir]) }}">
                          <i class="mdi mdi-email-open-outline"></i>
                          </a>
                          <a href="{{ route('editavoir', ['id' => $avoir->id]) }}">
