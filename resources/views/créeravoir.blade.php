...
<html lang="en">
  ...
  <li class="nav-item">
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Créer un Avoir</h4>
                    <p class="card-description"> Cordonnées D''avoir</p>
                    <form class="forms-sample" action="{{ route('avoir.insert') }}" method="POST">
                    @csrf

                    <div class="form-group row">
                    <div class="col-md-6">
    <label for="exampleInputEmail3">Client</label>
    <select class="js-select2 form-control" name="numclient" required>
  ...
  <div class="col-md-6">
    <label for="exampleInputName1">Date Avoir</label>
    <input type="date" class="form-control" id="exampleInputName1" name="date" required>
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Désignation</label>
                        <input type="text" class="form-control" name="designation" required>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputPassword4">Montant</label>
                        <input type="number" class="form-control" name="montant" step="0.01" required>
                      </div>


                      <button type="submit" class="btn btn-primary mr-2">Créer Avoir</button>
                    </form>
                  </div>
                </div>
              </div>
