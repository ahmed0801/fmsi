...
<html lang="en">
  ...
  <li class="nav-item">
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Ajouter un Service Ou Produit</h4>
                    <p class="card-description"> Cordonnées Du Service / Produit </p>
                    <form class="forms-sample" action="{{ route('service.insert') }}" method="POST">
                    @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="montant_ht" required>
                      </div>

                      <!-- <div class="form-group">
                        <label for="exampleInputPassword4">TVA</label>
                        <input type="number" class="form-control" name="tva" step="0.01" required>
                      </div> -->
