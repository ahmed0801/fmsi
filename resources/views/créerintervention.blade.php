...
@endif
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Créer un Rapport D'ntervention</h4>
                    <p class="card-description"> Cordonnées D'intervention</p>
                    <form class="forms-sample" action="{{ route('intervention.insert') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <select id="clientselect" class="js-select2 form-control" name="numclient" required>
        <option value="" disabled selected>Choisissez un client</option>
        @foreach ($clients as $client)
            <option value="{{ $client->numclient }}">{{ $client->numclient }} / {{ $client->nameclient }}</option>
        @endforeach
    </select>
</div>
...
<script>
  ...
  <div class="col-md-6">
    <label for="exampleInputName1">Date Intervention</label>
    <input type="date" class="form-control" id="exampleInputName1" name="date" required>
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Détails</label>
                        <textarea class="form-control" name="détail" rows="10" required></textarea>
                      </div>

                      <div class="form-group">
    <label for="images">Images d'intervention</label>
    <input type="file" class="form-control-file" name="images[]" multiple>
                      ...
                      <button type="submit" class="btn btn-primary mr-2">Créer Intervention</button>
                    </form>
                  </div>
                </div>
              </div>
