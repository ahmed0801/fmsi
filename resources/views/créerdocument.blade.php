...
@endif
    ...
    <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Créer un Documment</h4>
                    <p class="card-description"> Cordonnées Du Document</p>
...
<script>
  ...
  <div class="col-md-6">
    <label for="exampleInputName1">Date Document</label>
    <input type="date" class="form-control" id="exampleInputName1" name="date" required>
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">Gestionnaire (Facultatif)</label>
                        <input type="text" class="form-control" name="gestionnaire">
                      </div>
                      ...
                      <button type="submit" class="btn btn-primary mr-2">Créer Document</button>
                    </form>
                  </div>
                </div>
              </div>
